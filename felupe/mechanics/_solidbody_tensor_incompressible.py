...
from ._solidbody_incompressible import StateNearlyIncompressible
...
class SolidBodyTensorNearlyIncompressible:
    ...
    def _gradient(self, field=None, parallel=False, jit=False, args=(), kwargs={}):
        ...
        function = self.umat.function([F, statevars], *args, **kwargs)

        self.results.stress = [function[0] + p * dJdF(F)[0]]
        self.results._statevars = function[-1]
    ...
    def _hessian(self, field=None, parallel=False, jit=False, args=(), kwargs={}):
        ...
        self.results.elasticity = [
            self.umat.gradient([F, statevars], *args, **kwargs)[0] + p * d2JdF2(F)[0]
        ]
