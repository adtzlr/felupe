...
- :class:`Line <felupe.Line>` (:class:`element.Line <felupe.element.Line>`) and :class:`mesh.Line <felupe.mesh.Line>` or 
- :class:`Triangle <felupe.Triangle>` (:class:`element.Triangle <felupe.element.Triangle>`) and :class:`mesh.Triangle <felupe.mesh.Triangle>`.
