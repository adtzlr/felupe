...
m1 = fe.constitution.SaintVenantKirchhoffSethHill(1, 0,   2.0)
m2 = fe.constitution.SaintVenantKirchhoffSethHill(0, 5000, 0)
#P = m.P
#A = m.A

def P(F, *args):
    return m1.P(F) + m2.P(F)

def A(F, *args):
    return m1.A(F) + m2.A(F)
